...
# #18  create a context to test signed-in users, who should be allowed to vote on posts
  context "signed in user" do
    ...
    describe "POST up_vote" do
# #19  we expect that the first time a user up votes a post, a new vote is created for the post
...
# #22  test to ensure that users are redirected back to the correct view (posts show or topics show) depending on which view they up voted from
...
# #23  test to ensure that users are redirected back to the correct view (posts show or topics show) depending on which view they up voted from
